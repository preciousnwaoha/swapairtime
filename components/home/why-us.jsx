...
const WhyUs = () => {
  return (
    <div className="bg-[#1d1d1d] py-4 mb-8">
        <PaddedContainer >
            ...
            <div >
                {REASONS.map((reason, index) => {
                    return <div key={index} className='mb-6 rounded-xl p-4 text-white bg-[#313131] shadow-md'>
                        {/* <div>{reason.icon}</div> */}
                        <h4 className='text-white font-semibold  mb-4'>{reason.text}</h4>
